...
(function() {
  var Model, NoSchema, WrongShemaError, _default, _isArray, _isMap, _toString, castObject, castValue, log, ref, reportCastIgnore,
  ...
  reportCastIgnore = (ref = process.env.NODE_ENV) !== 'production' && ref !== 'test';
